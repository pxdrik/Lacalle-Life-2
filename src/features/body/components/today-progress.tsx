...
export function TodayProgress() {
  ...
  return (
    <Link
      href="/evolucao"
      className="flex min-w-0 flex-wrap items-center justify-between gap-x-4 gap-y-1 rounded-sm px-1 py-2 transition-colors duration-150 ease-out hover:bg-muted lg:col-span-2"
    >
